...
class SimonGame {
  constructor({winRounds=20, displayEl, pads, startBtn, strictCheckbox, messageEl}){
    ...
    this.frequencies = [329.63, 261.63, 220.00, 392.00]; // E4, C4, A3, G4
  ...
  init(){
    ...
    this.strictCheckbox.addEventListener('change', (e) => { this.strict = e.target.checked; });

    this.pads.forEach(p => {
      p.addEventListener('click', (e) => this.onPadClick(e));
      // Improve touch responsiveness
      p.addEventListener('touchstart', (e) => { e.preventDefault(); this.onPadClick(e); }, {passive:false});
    });
